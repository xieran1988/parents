...
#define gst_tidmaibuffer_VIDEOSRC_FREE  0x8
#define gst_tidmaibuffer_DISPLAY_FREE    0x10
...
struct _GstTIDmaiBufferTransport {
    ...
    /* Define callback function executed at end of finalize routine */
    void *callback_args;
    void (*callback) (void*, GstBuffer*);
};
...
GstBuffer* gst_tidmaibuffertransport_new(Buffer_Handle, GstTIDmaiBufTab*, void (*callback) (void*, GstBuffer*), 
 void *args);
